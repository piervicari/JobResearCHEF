...
PROBES = [
    ("bamboohr_embed2", "https://detectify.bamboohr.com/jobs/embed2.php", {}),
    ("teamtailor_rss2", "https://polestar.teamtailor.com/jobs.rss",
     {"Accept": "application/rss+xml, text/xml"}),
    ("workable_widget2", "https://apply.workable.com/api/v1/widget/accounts/starling-bank",
